...
if IS_REAL:
    ...
    WORKSPACE_LIMITS = np.asarray([[0.246, 0.764], [-0.28, 0.28], [-0.0001, 0.4]]) # np.asarray([[0.276, 0.724], [-0.26, 0.26], [-0.0001, 0.4]]) # np.asarray([[0.176, 0.824], [-0.324, 0.924], [-0.0001, 0.4]])
